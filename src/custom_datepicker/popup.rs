...
struct CustomDatePickerButtonState {
    year: i32,
    month: u32,
    day: u32,
    setup: bool,
...
impl CustomDatePickerButtonState {
...
pub(crate) struct CustomDatePickerPopup<'a> {
...
impl CustomDatePickerPopup<'_> {
    ...
    pub fn draw(&mut self, ui: &mut Ui) -> bool {
        ...
        let mut popup_state = ui
            .data_mut(|data| data.get_persisted::<CustomDatePickerButtonState>(id))
            .unwrap_or_default();
